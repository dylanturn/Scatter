...
public class Scatter {
    ...
    private final static int IPVER = Integer.parseInt(System.getenv("IPVER"));
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        messenger = new Messenger(CLUSTER_NAME, CLUSTER_ADDR, CLUSTER_PORT, BIND_INTERFACE, IPVER);
